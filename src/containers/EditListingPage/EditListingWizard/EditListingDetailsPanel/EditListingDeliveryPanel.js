...
const getInitialValues = props => {
  ...
  const { geolocation, publicData,protectedData, price } = listing?.attributes || {};
  ...
  const shippingRatePerKm = publicData?.shippingRatePerKm 
    ...
    : null;
  const minimumShippingFee = publicData?.minimumShippingFee
    ? new Money(publicData.minimumShippingFee, currency)
    : null;
            ...
            const shippingDataMaybe =
              shippingEnabled && shippingPriceInSubunitsOneItem != null
                ? {
                    ...
                    shippingRatePerKm: shippingRatePerKm?.amount,
                    minimumShippingFee: minimumShippingFee?.amount,
                  }
                : {};
